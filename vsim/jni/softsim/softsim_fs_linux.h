 ...
 * Date: 2016-08-13
 ******************************************************************************/
#ifndef __SOFTSIM_FS_LINUX_H__
#define __SOFTSIM_FS_LINUX_H__
...
* Define																	   
*****************************************************************************/
#if defined(__SOFTSIM_LINUX__)
	#define SOFTSIM_LINUX_SYSTEM_DISK			"./COS"
	#define SOFTSIM_LINUX_NORMAL_DISK			"./COS"
#elif defined(__SOFTSIM_ANDROID__)
	#if defined(__SOFTSIM_AUTH_DEMO__)
	#define SOFTSIM_LINUX_SYSTEM_DISK			"/storage/sdcard0/TooGoodManager/Logs/VSIM_DEMO"
	#define SOFTSIM_LINUX_NORMAL_DISK			"/storage/sdcard0/TooGoodManager/Logs/VSIM_DEMO"
	#else
	#define SOFTSIM_LINUX_SYSTEM_DISK			"/storage/sdcard0/TooGoodManager/Logs/VSIM"
	#define SOFTSIM_LINUX_NORMAL_DISK			"/storage/sdcard0/TooGoodManager/Logs/VSIM"
	#endif
#else
	#define SOFTSIM_LINUX_SYSTEM_DISK			"./COS"
	#define SOFTSIM_LINUX_NORMAL_DISK			"./COS"
