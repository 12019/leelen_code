 ...
 * Date: 2016-07-08
 ******************************************************************************/
#ifndef __SOFTSIM_SYSTEM_H__
#define __SOFTSIM_SYSTEM_H__
...
* Define																	   
*****************************************************************************/
#define SOFTSIM_SYSTEM_CMD_RESULT_LEN		(512)
#define SOFTSIM_SYSTEM_CMD_BUFFER_LEN		(512) 

#define	SOFTSIM_SYSTEM_TIME_ZONE			(8)
/*****************************************************************************
* Typedef																	   
*****************************************************************************/
typedef struct
...
*****************************************************************************/
extern void softsim_get_local_time(SoftsimDateTime *date_time);
extern void softsim_get_system_time(SoftsimDateTime *date_time);
extern void softsim_set_system_time(SoftsimDateTime *date_time);
extern u32 softsim_get_system_msec(void);
extern bool softsim_utc_sec_to_date(u32 utc_sec, SoftsimDateTime *date_time);
extern u32 softsim_utc_date_to_sec(SoftsimDateTime *date_time);
extern void softsim_system_cmd(const char* cmd_buffer);
/****************************************************************************
* Function
****************************************************************************/
#ifdef __cplusplus
