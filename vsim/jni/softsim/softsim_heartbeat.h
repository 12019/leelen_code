...
/*****************************************************************************/
#ifndef __SOFTSIM_HEARTBEAT_H__
#define __SOFTSIM_HEARTBEAT_H__
...
*****************************************************************************/
extern s32 softsim_send_signal(s32 signal);
extern void softsim_heartbeat_status_check_stop(void);
extern void softsim_heartbeat_init(void);
extern void softsim_heartbeat_status_update(bool status);
extern void softsim_heartbeat_exit(void);
/****************************************************************************
* Function
****************************************************************************/
