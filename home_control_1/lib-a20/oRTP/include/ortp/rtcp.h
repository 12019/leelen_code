...
typedef enum {
    RTCP_SDES_END_LPHONE		= 0,
    RTCP_SDES_CNAME_LPHONE 	= 1,
    RTCP_SDES_NAME_LPHONE	= 2,
    RTCP_SDES_EMAIL_LPHONE	= 3,
    RTCP_SDES_PHONE_LPHONE	= 4,
    RTCP_SDES_LOC_LPHONE		= 5,
    RTCP_SDES_TOOL_LPHONE	= 6,
    RTCP_SDES_NOTE_LPHONE	= 7,
    RTCP_SDES_PRIV_LPHONE		= 8,
    RTCP_SDES_MAX_LPHONE		= 9
} rtcp_sdes_type_t;
