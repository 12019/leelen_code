...
} s3c_tvenc_mem_alloc_t;

#define S3C_TVOUT_ALLOC_KMEM  	_IOWR ('V', BASE_VIDIOC_PRIVATE+4, s3c_tvenc_mem_alloc_t)
#define S3C_TVOUT_FREE_KMEM  	_IOWR ('V', BASE_VIDIOC_PRIVATE+5, s3c_tvenc_mem_alloc_t)
//lg
