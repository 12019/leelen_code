...
static int config_de_parameter(unsigned int width, unsigned int height, __disp_pixel_fmt_t format) {
	...
	tmpLayerAttr.scn_win.x = 50;//0;
	tmpLayerAttr.scn_win.y = 50;//0;
	tmpLayerAttr.scn_win.width  = 640;//hnd_video_render->video_window.width;
	tmpLayerAttr.scn_win.height = 480;//hnd_video_render->video_window.height;
	tmpLayerAttr.prio           = 0xff;
